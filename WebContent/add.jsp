                    ...
                    <form action="delivery" method="post">
                        ...
                        <table width="100%" border="0" cellpadding="8"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="deliveryName" size="40" class="inpMain"
                                           value="${sysDelivery.deliveryName}" />
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <select name="companyId">
                                        ...
                                        <c:forEach items="${allCompany}" var="company">
                                            ...
                                            <option value="${company.id}"
                                                ${company.id == sysDelivery.companyId ?"selected":""}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="phone" size="40" class="inpMain" value="${sysDelivery.phone}"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <%--H5版本的HTML支持date类型的input标签，它会自带日历的组件--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    <%--checked表示默认选中未发件--%>
                                    <c:if test="${sysDelivery==null}">
                                        <input type="radio" name="state" value="0" size="40" checked />
                                    </c:if>
                                    <c:if test="${sysDelivery!=null}">
