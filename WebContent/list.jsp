        ...
        <script>
            ...
            function confirmDelete(id){
                ...
                if(result == true){
                    ...
                    //设置请求路径和请求方式
                    xmlhttp.open("GET","delivery?method=remove&id="+id ,true);
                    //发生请求
                    xmlhttp.send();
                }
            }
                        ...
                        <table width="100%" border="0" cellpadding="8"
                            ...
                            <c:forEach items="${allDelivery}" var="delivery">
                                <tr id="${delivery.id}">
                                    ...
                                    <td><a href="delivery?method=prepareUpdate&id=${delivery.id}">编辑</a> |
                                        <a href="#" onclick="confirmDelete(${delivery.id})">删除</a> </td>
                                </tr>
                            </c:forEach>
                        </table>
                    </div>
